...
function Mapfill_candy(Map_ID, Map_Size_X, Map_Size_Y, Map_Size_Z, arguments)
	System.msgAll(Map_ID, "&3arguments: "..arguments)
			...
			for iz=0,height do
				...
				for ix=0,HMap_Scale-1 do
					for iy=0,HMap_Scale-1 do
						Map.setblock(-1, Map_ID, bx+ix,by+iy,iz, mat, 0, 0, 0, 0)
					end
				end
				mat = mat+1
			end
	...
	System.msgAll(Map_ID, "&2Constructed \"candy\" in &a"..os.clock()-time.."&2s.")
	System.msgAll(Map_ID, "&2Took a total of &a"..os.clock()-ttime.."&2s.")
end
System.msgAll(-1, "&0dbg4")
